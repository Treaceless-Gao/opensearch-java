...
public class OpenSearchSecurityAsyncClient extends ApiClient<UdbsxTransport, OpenSearchSecurityAsyncClient> {
    public OpenSearchSecurityAsyncClient(UdbsxTransport transport) {
        super(transport, null);
    }

    public OpenSearchSecurityAsyncClient(UdbsxTransport transport, @Nullable TransportOptions transportOptions) {
     ...
     */
    public CompletableFuture<AuthinfoResponse> authinfo(AuthinfoRequest request) throws IOException, UdbsxException {
     ...
     * Returns or updates authentication information for the currently authenticated user.
     */
    public final CompletableFuture<AuthinfoResponse> authinfo() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<AuthtokenResponse> authtoken(AuthtokenRequest request) throws IOException, UdbsxException {
     ...
     * Returns the authorization token for the current user.
     */
    public final CompletableFuture<AuthtokenResponse> authtoken() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<ChangePasswordResponse> changePassword(ChangePasswordRequest request) throws IOException, UdbsxException {
     ...
     * Checks whether or not an upgrade can be performed and which security resources can be updated.
     */
    public final CompletableFuture<ConfigUpgradeCheckResponse> configUpgradeCheck() throws IOException, UdbsxException {
     ...
     * Assists the cluster operator with upgrading missing default values and stale default definitions.
     */
    public final CompletableFuture<ConfigUpgradePerformResponse> configUpgradePerform() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<CreateAllowlistResponse> createAllowlist(CreateAllowlistRequest request) throws IOException, UdbsxException {
     ...
     * Creates or replaces APIs permitted for users on the allow list. Requires a super admin certificate or REST API permissions.
     */
    public final CompletableFuture<CreateAllowlistResponse> createAllowlist() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<CreateRoleResponse> createRole(CreateRoleRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<CreateTenantResponse> createTenant(CreateTenantRequest request) throws IOException, UdbsxException {
     ...
     * Creates or replaces the multi-tenancy configuration. Requires super admin or REST API permissions.
     */
    public final CompletableFuture<CreateUpdateTenancyConfigResponse> createUpdateTenancyConfig() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<CreateUserResponse> createUser(CreateUserRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<DeleteRoleResponse> deleteRole(DeleteRoleRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<DeleteTenantResponse> deleteTenant(DeleteTenantRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<DeleteUserResponse> deleteUser(DeleteUserRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<FlushCacheResponse> flushCache(FlushCacheRequest request) throws IOException, UdbsxException {
     ...
     * Flushes the Security plugin's user, authentication, and authorization cache.
     */
    public final CompletableFuture<FlushCacheResponse> flushCache() throws IOException, UdbsxException {
     ...
     * Returns account information for the current user.
     */
    public final CompletableFuture<GetAccountDetailsResponse> getAccountDetails() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetActionGroupResponse> getActionGroup(GetActionGroupRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetActionGroupsResponse> getActionGroups(GetActionGroupsRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves all action groups.
     */
    public final CompletableFuture<GetActionGroupsResponse> getActionGroups() throws IOException, UdbsxException {
     ...
     * Retrieves the cluster security certificates.
     */
    public final CompletableFuture<GetAllCertificatesResponse> getAllCertificates() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetAllowlistResponse> getAllowlist(GetAllowlistRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves the current list of allowed APIs accessible to a normal user.
     */
    public final CompletableFuture<GetAllowlistResponse> getAllowlist() throws IOException, UdbsxException {
     ...
     * Retrieves the audit configuration.
     */
    public final CompletableFuture<GetAuditConfigurationResponse> getAuditConfiguration() throws IOException, UdbsxException {
     ...
     * Retrieves the cluster security certificates.
     */
    public CompletableFuture<GetCertificatesResponse> getCertificates(GetCertificatesRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves the cluster security certificates.
     */
    public final CompletableFuture<GetCertificatesResponse> getCertificates() throws IOException, UdbsxException {
     ...
     * Returns the current Security plugin configuration in a JSON format.
     */
    public final CompletableFuture<GetConfigurationResponse> getConfiguration() throws IOException, UdbsxException {
     ...
     * Retrieves the current values for dynamic security settings for OpenSearch Dashboards.
     */
    public final CompletableFuture<GetDashboardsInfoResponse> getDashboardsInfo() throws IOException, UdbsxException {
     ...
     * Retrieves all node distinguished names. Requires super admin or REST API permissions.
     */
    public final CompletableFuture<GetDistinguishedNamesResponse> getDistinguishedNames() throws IOException, UdbsxException {
     ...
     * Retrieves the evaluated REST API permissions for the currently logged in user.
     */
    public final CompletableFuture<GetPermissionsInfoResponse> getPermissionsInfo() throws IOException, UdbsxException {
     ...
     * Retrieves one role.
     */
    public CompletableFuture<GetRoleResponse> getRole(GetRoleRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetRoleMappingResponse> getRoleMapping(GetRoleMappingRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetRoleMappingsResponse> getRoleMappings(GetRoleMappingsRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves all role mappings.
     */
    public final CompletableFuture<GetRoleMappingsResponse> getRoleMappings() throws IOException, UdbsxException {
     ...
     * Retrieves all roles.
     */
    public CompletableFuture<GetRolesResponse> getRoles(GetRolesRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves all roles.
     */
    public final CompletableFuture<GetRolesResponse> getRoles() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetSslinfoResponse> getSslinfo(GetSslinfoRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves information about the SSL configuration.
     */
    public final CompletableFuture<GetSslinfoResponse> getSslinfo() throws IOException, UdbsxException {
     ...
     * Retrieves the multi-tenancy configuration. Requires super admin or REST API permissions.
     */
    public final CompletableFuture<GetTenancyConfigResponse> getTenancyConfig() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetTenantResponse> getTenant(GetTenantRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetTenantsResponse> getTenants(GetTenantsRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves all tenants.
     */
    public final CompletableFuture<GetTenantsResponse> getTenants() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetUserResponse> getUser(GetUserRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetUserLegacyResponse> getUserLegacy(GetUserLegacyRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetUsersResponse> getUsers(GetUsersRequest request) throws IOException, UdbsxException {
     ...
     * Retrieve all internal users.
     */
    public final CompletableFuture<GetUsersResponse> getUsers() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<GetUsersLegacyResponse> getUsersLegacy(GetUsersLegacyRequest request) throws IOException, UdbsxException {
     ...
     * Retrieve all internal users. Legacy API.
     */
    public final CompletableFuture<GetUsersLegacyResponse> getUsersLegacy() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<MigrateResponse> migrate(MigrateRequest request) throws IOException, UdbsxException {
     ...
     * Migrates the security configuration from v6 to v7.
     */
    public final CompletableFuture<MigrateResponse> migrate() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchAllowlistResponse> patchAllowlist(PatchAllowlistRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchRoleResponse> patchRole(PatchRoleRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchRolesResponse> patchRoles(PatchRolesRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchTenantResponse> patchTenant(PatchTenantRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchTenantsResponse> patchTenants(PatchTenantsRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchUserResponse> patchUser(PatchUserRequest request) throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<PatchUsersResponse> patchUsers(PatchUsersRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves the current values for dynamic security settings for OpenSearch Dashboards.
     */
    public final CompletableFuture<PostDashboardsInfoResponse> postDashboardsInfo() throws IOException, UdbsxException {
     ...
     * Reloads the HTTP communication certificates.
     */
    public final CompletableFuture<ReloadHttpCertificatesResponse> reloadHttpCertificates() throws IOException, UdbsxException {
     ...
     * Reloads the transport communication certificates.
     */
    public final CompletableFuture<ReloadTransportCertificatesResponse> reloadTransportCertificates() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<TenantInfoResponse> tenantInfo(TenantInfoRequest request) throws IOException, UdbsxException {
     ...
     * Retrieves the names of current tenants. Requires super admin or <code>kibanaserver</code> permissions.
     */
    public final CompletableFuture<TenantInfoResponse> tenantInfo() throws IOException, UdbsxException {
     ...
     * Updates the audit configuration.
     */
    public final CompletableFuture<UpdateAuditConfigurationResponse> updateAuditConfiguration() throws IOException, UdbsxException {
     ...
     * Updates the settings for an existing security configuration. Requires super admin or REST API permissions.
     */
    public final CompletableFuture<UpdateConfigurationResponse> updateConfiguration() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<ValidateResponse> validate(ValidateRequest request) throws IOException, UdbsxException {
     ...
     * Checks whether the v6 security configuration is valid and ready to be migrated to v7.
     */
    public final CompletableFuture<ValidateResponse> validate() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<WhoAmIResponse> whoAmI(WhoAmIRequest request) throws IOException, UdbsxException {
     ...
     * Gets the identity information for the user currently logged in.
     */
    public final CompletableFuture<WhoAmIResponse> whoAmI() throws IOException, UdbsxException {
     ...
     */
    public CompletableFuture<WhoAmIProtectedResponse> whoAmIProtected(WhoAmIProtectedRequest request) throws IOException, UdbsxException {
     ...
     * authorization at REST layer is enabled.
     */
    public final CompletableFuture<WhoAmIProtectedResponse> whoAmIProtected() throws IOException, UdbsxException {
