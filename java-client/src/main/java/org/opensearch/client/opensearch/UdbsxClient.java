...
import org.opensearch.client.opensearch.generic.UdbsxGenericClient;
 ...
 */
public class UdbsxClient extends UdbsxClientBase<UdbsxClient> {
    public UdbsxClient(UdbsxTransport transport) {
        super(transport, null);
    }

    public UdbsxClient(UdbsxTransport transport, @Nullable TransportOptions transportOptions) {
        super(transport, transportOptions);
    }

    @Override
    public UdbsxClient withTransportOptions(@Nullable TransportOptions transportOptions) {
        return new UdbsxClient(this.transport, transportOptions);
    }

    // ----- Child clients
    public UdbsxGenericClient generic() {
        return new UdbsxGenericClient(this.transport, this.transportOptions);
    }
    ...
    public BulkResponse bulk(BulkRequest request) throws IOException, UdbsxException {
    ...
    public final BulkResponse bulk(Function<BulkRequest.Builder, ObjectBuilder<BulkRequest>> fn) throws IOException, UdbsxException {
    ...
    public BulkResponse bulk() throws IOException, UdbsxException {
    ...
    public <TDocument> CreateResponse create(CreateRequest<TDocument> request) throws IOException, UdbsxException {
        @SuppressWarnings("unchecked")
    ...
    public <TDocument> IndexResponse index(IndexRequest<TDocument> request) throws IOException, UdbsxException {
        @SuppressWarnings("unchecked")
    ...
    public <TDocument> TermvectorsResponse termvectors(TermvectorsRequest<TDocument> request) throws IOException, UdbsxException {
        @SuppressWarnings("unchecked")
